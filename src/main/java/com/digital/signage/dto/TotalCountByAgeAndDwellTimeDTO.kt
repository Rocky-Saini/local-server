...
import com.digital.signage.util.ApplicationConstants.BIG_DECIMAL_KILO
import com.fasterxml.jackson.annotation.JsonProperty
import java.math.BigDecimal
import java.math.RoundingMode

data class TotalCountByAgeAndDwellTimeDTO(
        @JsonProperty(DWELL_TIME_JSON_KEY)
        var dwellTime: String? = null,
    ...
    companion object {
        const val DWELL_TIME_JSON_KEY = "dwellTime"
        ...
        fun dwellTimeMillisToSec(
                dwellTime: BigDecimal?
        ): String? = dwellTime?.divide(
                BIG_DECIMAL_KILO,
                2,
