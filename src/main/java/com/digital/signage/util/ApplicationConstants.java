...
/**
 * @author -Ravi Kumar created on 12/23/2022 12:38 AM
...
public class ApplicationConstants {
    ...
    public static final Set<ContentType> SET_ALL_EDITABLE_CONTENT_TYPES_POST_PUBLISH =
            new HashSet<>(2);

    public static final Set<ContentType> SET_ALL_EDITABLE_DURATION_ON_CONTENT_TYPES_POST_PUBLISH =
            new HashSet<>(7);

    public static final Set<ContentType> SET_ALL_DOWNLOADABLE_CONTENT_TYPES =
            new HashSet<>(7);
    ...
    public static final int MAX_ITEMS_PER_PAGE_FOR_REPORTS_PAGINATION = 100;
    public static final int DEFAULT_PAGE_NO_FOR_REPORTS_PAGINATION = 1;
    public static final String IDS = "Ids";
    public static final int MAX_NUMBER_OF_LOOPS_FOR_LAYOUT_STRING = 10;
    ...
    public static final long LAYOUT_ADVERTISEMENT_DURATION_MAX_LENGTH = 86400;
    ...
    public static final String REPLACE_CUSTOMER_ID = "{customer-id}";
    ...
    static {
        ...
        SET_ALL_EDITABLE_CONTENT_TYPES_POST_PUBLISH.add(ContentType.TEXT);
        SET_ALL_EDITABLE_CONTENT_TYPES_POST_PUBLISH.add(ContentType.HTML);
        SET_ALL_EDITABLE_CONTENT_TYPES_POST_PUBLISH.add(ContentType.URL);
        SET_ALL_EDITABLE_CONTENT_TYPES_POST_PUBLISH.add(ContentType.TWITTER);
        SET_ALL_EDITABLE_CONTENT_TYPES_POST_PUBLISH.add(ContentType.FACEBOOK);
        SET_ALL_EDITABLE_CONTENT_TYPES_POST_PUBLISH.add(ContentType.RSS);
        SET_ALL_EDITABLE_CONTENT_TYPES_POST_PUBLISH.add(ContentType.STREAM_URL);

        SET_ALL_EDITABLE_DURATION_ON_CONTENT_TYPES_POST_PUBLISH.add(ContentType.TEXT);
        SET_ALL_EDITABLE_DURATION_ON_CONTENT_TYPES_POST_PUBLISH.add(ContentType.HTML);
        SET_ALL_EDITABLE_DURATION_ON_CONTENT_TYPES_POST_PUBLISH.add(ContentType.URL);
        SET_ALL_EDITABLE_DURATION_ON_CONTENT_TYPES_POST_PUBLISH.add(ContentType.TWITTER);
        SET_ALL_EDITABLE_DURATION_ON_CONTENT_TYPES_POST_PUBLISH.add(ContentType.FACEBOOK);
        SET_ALL_EDITABLE_DURATION_ON_CONTENT_TYPES_POST_PUBLISH.add(ContentType.RSS);
        SET_ALL_EDITABLE_DURATION_ON_CONTENT_TYPES_POST_PUBLISH.add(ContentType.STREAM_URL);

        SET_ALL_DOWNLOADABLE_CONTENT_TYPES.add(ContentType.VIDEO);
        SET_ALL_DOWNLOADABLE_CONTENT_TYPES.add(ContentType.AUDIO);
        SET_ALL_DOWNLOADABLE_CONTENT_TYPES.add(ContentType.IMAGE);
        SET_ALL_DOWNLOADABLE_CONTENT_TYPES.add(ContentType.FLASH);
        SET_ALL_DOWNLOADABLE_CONTENT_TYPES.add(ContentType.PDF);
        SET_ALL_DOWNLOADABLE_CONTENT_TYPES.add(ContentType.DOC);
        SET_ALL_DOWNLOADABLE_CONTENT_TYPES.add(ContentType.PPT);
