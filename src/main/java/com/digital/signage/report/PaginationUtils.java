...
public class PaginationUtils {
    ...
    public static Pagination getPagination(Page page, Pageable pageRequest) {
        ...
        pagination.setCurrentPage((int) pageRequest.getOffset() + 1);
        pagination.setNumPerPage(pageRequest.getPageSize());
        pagination.setPageCount(page.getTotalPages());
        pagination.setNextPage(
                page.getTotalPages() > ((int)pageRequest.getOffset() + 1) ? (int)pageRequest.getOffset() + 1 : null);
        pagination.setPreviousPage((int)pageRequest.getOffset() > 1 ? (int)pageRequest.getOffset() - 1 : null);
