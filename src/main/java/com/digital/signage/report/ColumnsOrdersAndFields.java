...
public class ColumnsOrdersAndFields {
    ...
    public ColumnsOrdersAndFields(Map<Integer, Field> orderAndFieldMap, List<Field> orderedFields,
                                  Map<Integer, String> orderAndColumnNameMap, List<Integer> orderList) {
