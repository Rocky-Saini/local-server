...
public class ApiResponse<T> {
    ...
    public static class ApiResponseBuilder<T> {
        ...
        public ApiResponseBuilder<T> occurredOn(LocalDateTime occurredOn) {
        ...
        public ApiResponse<T> build() {
            return new ApiResponse<T>(status, occurredOn, message, debugMessage, remedialMessage, data, errors, paginationDetail);
        }
